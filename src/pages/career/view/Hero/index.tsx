const CareerHero = () => {
  return (
    <div className="px-5 py-20 md:py-32 bg-career bg-blend-screen bg-[#006AB4] bg-center bg-no-repeat bg-cover">
      <div className="w-full md:max-w-[1200px] mx-auto text-white flex flex-col gap-10">
